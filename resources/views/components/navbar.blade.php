    ...
    <nav class="bg-amber-100 border-4 border-black rounded-3xl p-4 shadow-[6px_6px_0_0_rgba(0,0,0,1)] relative overflow-hidden">
        ...
        <div class="flex justify-between items-center z-10 relative">
            ...
            <div class="flex justify-end items-center gap-4">
                ...
                <a href="{{route('dashboard.index')}}" class="bg-pink-200 border-2 border-black rounded-full px-5 py-2 text-sm font-semibold text-black shadow-[3px_3px_0_0_rgba(0,0,0,1)] hover:shadow-[5px_5px_0_0_rgba(0,0,0,1)] transition-all duration-200 -rotate-1 hover:rotate-0 hover:-translate-y-0.5">Dashboard</a>
